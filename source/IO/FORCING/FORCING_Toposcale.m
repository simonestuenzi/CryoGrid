...
classdef FORCING_Toposcale < matlab.mixin.Copyable
    ...
    methods
        ...
        function forcing = finalize_init(forcing, tile)
            ...
            for i=1:size(coords,1)
                ...
                p_interp = (1-fraction_above_p) .* p_below_surface_altitude + fraction_above_p .* p_above_surface_altitude;
                ...
                p = p + idw(coords(i,1), coords(i,2)) .* p_interp';
            end
        ...
        function forcing = interpolate_forcing(forcing, tile)
            ...
            forcing.TEMP.Lin = forcing.PARA.sky_view_factor .* LW + (1 - forcing.PARA.sky_view_factor) .* forcing.CONST.sigma .* (tile.TOP.NEXT.STATVAR.T2m+273.15).^4;
