...
%             if ground.PARENT_GROUND.STATVAR.upperPos == 10.799999999999606
% %                 vegetation.soilvar.h2osoi_ice = ground.PARENT_GROUND.STATVAR.ice(range)' ./ (ground.PARENT_GROUND.STATVAR.area(range)' .* ground.PARENT_GROUND.STATVAR.layerThick(range)'); %ground.PARENT_GROUND.STATVAR.layerThick_wo_xIce(range) or layerThick -xIce/Area
...
%                 vegetation.soilvar.h2osoi_ice = ground.PARENT_GROUND.STATVAR.ice(range)' ./ (ground.PARENT_GROUND.STATVAR.area(range)' .* ground.PARENT_GROUND.STATVAR.layerThick_wo_Xice(range)'); %ground.PARENT_GROUND.STATVAR.layerThick_wo_xIce(range) or layerThick -xIce/Area
%                 vegetation.soilvar.h2osoi_vol = ground.PARENT_GROUND.STATVAR.water(range)' ./ (ground.PARENT_GROUND.STATVAR.area(range)' .* ground.PARENT_GROUND.STATVAR.layerThick_wo_Xice(range)');
%             else
%                 disp('surface moving?');
%                 disp('PARENT_SURFACE');
%                 disp(ground.PARENT_SURFACE.STATVAR.upperPos);
%                 disp('PARENT_GROUND');
%                 disp(ground.PARENT_GROUND.STATVAR.upperPos);
