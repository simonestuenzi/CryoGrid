...
ground.STATVAR.vegetation.mlcanopyinst.tref = forcing.DATA.Tair+273.15;                % should be in Kelvin?                       %Air temperature at reference height (K)                            Atmospheric input variables
ground.STATVAR.vegetation.mlcanopyinst.uref = forcing.DATA.wind;                          %Wind speed at reference height (m/s)                               Atmospheric input variables
...
% forcing.DATA.p = forcing.DATA.pressure;
ground.STATVAR.vegetation.mlcanopyinst.pref = forcing.DATA.p;                             %Air pressure at reference height (Pa)                              Atmospheric input variables
