...
%                 disp('vegetation with snow');
               %vegetation part
                ...
                transpiration = max(0,transpiration);
...
%                     ground.STATVAR.evap = ground.STATVAR.evaporationoration;
...
%                 end
        ...
        function [ground, S_up] = penetrate_SW_PARENT(ground, S_down)  %mandatory function when used with class that features SW penetration
            [ground, S_up] = penetrate_SW_PARENT@GROUND_freezeC_RichardsEqW_Xice_seb_vegetation(ground, S_down);
        end
        
        function [ground, L_up] = penetrate_LW(ground, L_down)  %mandatory function when used with class that features SW penetration
            [ground, L_up] = penetrate_LW@GROUND_freezeC_RichardsEqW_Xice_seb_vegetation(ground, L_down);
        end
